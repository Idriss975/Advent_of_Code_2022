...
public:
    ...
    bool overlaps(const Pair &Line) const
    {
        return (Left <= Line.Left && Right >= Line.Right) || (Left >= Line.Left && Right <= Line.Right) || (Line.Left >= Left && Line.Left <= Right) || (Line.Right >= Left && Line.Right <= Right);
    }
};
